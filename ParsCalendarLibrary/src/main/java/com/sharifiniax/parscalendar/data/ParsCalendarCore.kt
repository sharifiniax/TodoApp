...
class ParsCalendarCore {
    ...
    private fun jdnToArabic() {
        val a: Double
        var b: Double
        val jd:Double = (jdn-1).toDouble()
        b = 0.0
        if (jd > 2299160) {
            a = floor((jd - 1867216.25) / 36524.25)
            b = 1 + a - floor(a / 4.0)
        }
        val bb: Double = jd + b + 1524
     ...
     *
     *
     * @param month is Iranian month
     * @param year is Iranian year
     * if month doesn't pass set automatically to current month
     * if year doesn't pass set automatically to current year
     *
     */
    fun iranianMonthLength(month: Int=iranianMonth,year: Int=iranianYear): Int {
        val principalDay=iranianDay
        val principalMonth=iranianMonth
        val principalYear= iranianYear
        setIranianDate(year,month,29)
        var lengthMonth=0
        var gone = true
        for (i in 1..4){
            jdn++
        ...
        setIranianDate(principalYear,principalMonth,principalDay)
     ...
     *
     */
    fun firstWeekDayOfMonth(month: Int=iranianMonth,year: Int=iranianYear): Int{
        val principalDay=iranianDay
        val principalMonth=iranianMonth
        val principalYear= iranianYear
        setIranianDate(year,month,1)
        val day=dayOfWeek
        setIranianDate(principalYear,principalMonth,principalDay)
        return day
    }
    ...
    fun goToCurrentDate(){
        setGregorianDate(GregorianCalendar()[Calendar.YEAR],
    ...
    /**
     * arabicDay:
     * Returns the 'day' part of the Arabic date.
     *
     * @return int
     */
    var arabicDay // Day part of a Gregorian date
            = 0
        private set

    /**
     * arabicMonth:
     * Returns the 'month' part of the Arabic date.
     *
     * @return int
     */
    var arabicMonth // Day part of a Gregorian date
            = 0
        private set
    ...
    /**
     * arabicDay:
     * Returns the 'year' part of the Arabic date.
     *
     * @return int
     */
    var arabicYear // Day part of a Gregorian date
            = 0
        private set
